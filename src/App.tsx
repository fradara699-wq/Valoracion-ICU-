            ...
            {activeTab === "teamwork" && (
              <div id="panel-teamwork" className="space-y-6">
                <ChecklistGenericoEditable 
                  ...
                  description="Gestión y tildaduras de pases estructurados (SBAR), debates clínicos interactivos y soporte continuo al factor humano."
                />
                <div className="flex justify-between pt-2">
                  <button
                    type="button"
            ...
            {activeTab === "tele-icu" && (
              <div id="panel-tele-icu" className="space-y-6">
                <ChecklistGenericoEditable 
                  ...
                  description="Plataforma de soporte consultivo, equipamientos telemétricos HD y monitorización a distancia autorizada de los pacientes de cuidados críticos."
                />
                <div className="flex justify-between pt-2">
                  <button
                    type="button"
            ...
            {activeTab === "docencia" && (
              <div id="panel-docencia" className="space-y-6">
                <ChecklistGenericoEditable 
                  ...
                  description="Residencias médicas homologadas por el Ministerio, ateneos bibliográficos activos y participación activa en redes analíticas de SATI."
                />
                <div className="flex justify-between pt-2">
                  <button
                    type="button"
            ...
            {activeTab === "sati" && (
              <div id="panel-sati" className="space-y-6">
                <ChecklistGenericoEditable 
                  ...
                  description="Adherencia a los manuales organizacionales de la Sociedad Argentina de Terapia Intensiva y presencia kine/médica avalada."
                />
                <div className="flex justify-between pt-2">
                  <button
                    type="button"
